...
skills:
  ...
  - UI/UX design
  - Documentation
description: Creates specification and planning documents based on Lead Designer instructions
allowed_tools:
  - shell
  - fs_read
  - fs_write
...
When completing a task, send a report to the Lead Designer:
